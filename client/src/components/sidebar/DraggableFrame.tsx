  ...
  return (
    ...
    >
      <CardContent className="p-3 transition-all">
        ...
        {/* Drag handle */}
        <div className="absolute top-1/2 -left-2 -translate-y-1/2 bg-background rounded-full border shadow-sm opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          >
            <HoverCard>
              <HoverCardTrigger asChild>
                <div className="mb-1">
                  <h3 className="font-medium text-sm">{frame.name}</h3>
                  {frame.subcategory && (
